...
@section('heading', 'Create Item')

@section('content')

    <form class="w-full max-w-lg" action="{{route('producer.item.store')}}">
        {{ @csrf_field() }}
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input class="block w-full text-gray-700 border rounded py-3 px-4 mb-3 leading-tight" name="itemName" type="text" placeholder="Apple..." required>
            </div>
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="itemPrice">
                    Item Price
                </label>
                <input class="block w-full text-gray-700 border rounded py-3 px-4 mb-3 leading-tight" name="itemPrice" type="money" placeholder="£9.99..." required>
            </div>
        </div>
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3 mb-6 md:mb-0">
                ...
                <textarea class="block w-full text-gray-700 border rounded py-3 px-4 mb-3 leading-tight"
                          name="itemDescription" placeholder="Description about your item..." required></textarea>
            </div>
        </div>
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="storeID">
                    Store
                </label>
                <div class="relative">
                    <select class="block appearance-none w-full border text-gray-700 py-3 px-4 pr-8 rounded leading-tight" name="storeID" required>
                        <option>Please select...</option>
