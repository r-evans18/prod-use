            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::guest() || Auth::user()->user_type === 'customer')
                        <x-jet-nav-link href="{{route('producer.index')}}" :active="request()->routeIs('producer.index')">
                            Producers
                        </x-jet-nav-link>
                    @endif
                    @if (!Auth::guest() && Auth::user()->user_type === 'producer')
                        <x-jet-nav-link href="{{route('producer.store.index')}}" :active="request()->routeIs('producer.store.index')">
                            My Stores
                        </x-jet-nav-link>
                        <x-jet-nav-link href="{{route('producer.item.index')}}" :active="request()->routeIs('producer.item.index')">
                            My Items
                        </x-jet-nav-link>
                    @endif
                </div>
